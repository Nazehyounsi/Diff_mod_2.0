...
class Model_mlp_diff(nn.Module):
    def __init__(self, observation_embedder, mi_embedder, sequence_length, net_type="transformer"):
        ...
        self.transformer_block5 = TransformerEncoderBlock(self.trans_emb_dim, self.transformer_dim, self.nheads)
    ...
    def forward(self, y, x, z, t, context_mask):
        ...
        block_output4 = self.transformer_block5(block_output3)


        # Flatten and add final linear layer
        transformer_out = block_output4.transpose(0, 1)  # Roll batch to first dim
